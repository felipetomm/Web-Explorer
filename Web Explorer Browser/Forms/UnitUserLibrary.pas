...
type
  ...
  private
    ...
    function ReturnImgAdr(imgAdr: string): string;
    function ReturnIMGIndex(imgindex: string): string;
  public
...
uses UnitMainForm, AppMenuForm, linkcenterform;

{ TBookmarks_mgc }

procedure TUserLibrary.S1Click(Sender: TObject);
begin
 SetSPDBg(7);
end;

procedure TUserLibrary.S2Click(Sender: TObject);
begin
 SetSPDBg(8);
end;

procedure TUserLibrary.S3Click(Sender: TObject);
begin
 SetSPDBg(10);
end;

procedure TUserLibrary.S4Click(Sender: TObject);
begin
 SetSPDBg(11);
end;

procedure TUserLibrary.SaveImport;
var
 index: integer;
 indexmax: Real;
begin
...
procedure TUserLibrary.SaveTilesSPD;
var
 ListItem : TListItem;
 index: integer;
begin
    ...
    if SPDItens.Items[index].SubItems[3] = 'AddMetroDoubleWithTrailerWithBG' then
     begin
      if StrtoInt(SPDItens.Items[index].Caption) < 1 then
       ...
       {$ELSE}
       NewTilesEdit.Lines.Add('$("#metroaqui_novo").'+ SPDItens.Items[index].SubItems[3] +'(' + QuotedStr('bt') + ', ' + QuotedStr('../../../Bin/Resources/Pages/images/' + ReturnImgAdr(SPDItens.Items[index].Caption)) + ', ' + QuotedStr(SPDItens.Items[index].SubItems[0]) + ', ' + QuotedStr(SPDItens.Items[index].SubItems[1]) + ', ' + QuotedStr(SPDItens.Items[index].SubItems[2]) + ');');
       {$ENDIF}
     end;
    if SPDItens.Items[index].SubItems[3] = 'AddMetroDoubleWithTrailer' then
     begin
      NewTilesEdit.Lines.Add('$("#metroaqui_novo").'+ SPDItens.Items[index].SubItems[3] +'(' + QuotedStr('bt') + ', '  + QuotedStr(SPDItens.Items[index].SubItems[2]) + ', ' + QuotedStr(ReturnIMGIndex(SPDItens.Items[index].Caption)) + ', ' + QuotedStr(SPDItens.Items[index].SubItems[0]) + ', ' + QuotedStr(SPDItens.Items[index].SubItems[1]) + ', ' + QuotedStr(SPDItens.Items[index].SubItems[2]) + ');');
     end;
...
procedure TUserLibrary.SearchEdit1KeyPress(Sender: TObject; var Key: Char);
var
  tStr : String;
  tSrch : String;
  i : Integer;
...
procedure TUserLibrary.SearchEdit2KeyPress(Sender: TObject; var Key: Char);
var
  tSrch: String;
  i: Integer;
  hItem: HTREEITEM;
...
procedure TUserLibrary.SetAnimatedBackground11Click(Sender: TObject);
begin
 SetSPDBg(0);
end;

procedure TUserLibrary.SetAnimatedBackground21Click(Sender: TObject);
begin
  SetSPDBg(1);
end;

procedure TUserLibrary.SetAnimatedBackground31Click(Sender: TObject);
begin
 SetSPDBg(4);
end;

procedure TUserLibrary.SetcustomWallpaper1Click(Sender: TObject);
begin
 SetSPDBg(3);
end;

procedure TUserLibrary.SetdefaultwallpaperStatic1Click(Sender: TObject);
begin
 SetSPDBg(2);
end;

procedure TUserLibrary.SetIslandsThemeAnimated1Click(Sender: TObject);
begin
 SetSPDBg(9);
end;

procedure TUserLibrary.SetMontainThemeAnimated1Click(Sender: TObject);
begin
 SetSPDBg(5);
end;

procedure TUserLibrary.SetRainThemeAnimated1Click(Sender: TObject);
begin
 SetSPDBg(6);
end;

procedure TUserLibrary.SetSPDBg(cmdtype: SmallInt);
var
 ColorCode: TColor;
{$IFDEF STORE}
 UWPDirUrl: string;
...
procedure TUserLibrary.SetSPDUpdate;
//var
...
procedure TUserLibrary.ShellListView1AddFolder(Sender: TObject;
  AFolder: TShellFolder; var CanAdd: Boolean);
begin
CanAdd := AFolder.IsFolder or (ExtractFileExt(AFolder.PathName) = '.exe');
end;

procedure TUserLibrary.SPDItensVClick(Sender: TObject);
begin
 SPDItens.ItemIndex := SPDItensV.ItemIndex;
end;

procedure TUserLibrary.StartPluginTimer(Sender: TObject);
begin
 ListAllPlugins;
 StartPlugin.Enabled := false;
end;

function TUserLibrary.TileColorFromSTR(StrColor: string): TColor;
begin
...
procedure TUserLibrary.TreeViewHistoryDblClick(Sender: TObject);
begin
 try
  if TreeViewHistory.Selected.ImageIndex <> 3 then
   begin
    ...
    MainForm.OpenAddressFromLink(UrlSCR.Items[TreeViewHistory.Selected.Index]);
   end;
 Except
 end;
 try
...
procedure TUserLibrary.ViewSelectPlugins(index: SmallInt);
begin
...
procedure TUserLibrary.W7ToolButton1Click(Sender: TObject);
begin
 close;
 MainForm.ClearOnlyHis;
end;

procedure TUserLibrary.W7ToolButton2Click(Sender: TObject);
begin
 close;
 MainForm.ClearCache := true;
end;

procedure TUserLibrary.W7ToolButton3Click(Sender: TObject);
var
...
procedure TUserLibrary.W7ToolButton4Click(Sender: TObject);
begin
 close;
...
procedure TUserLibrary.W7ToolButton5Click(Sender: TObject);
begin
 ClearDownloads;
end;

procedure TUserLibrary.W7ToolButton6Click(Sender: TObject);
begin
 ShellExecute(handle,'open', 'explorer', Pchar(AppMenu.opt_downloaddir.Text),nil,SW_SHOWNORMAL);
end;

procedure TUserLibrary.W7ToolButton7Click(Sender: TObject);
begin
 OpenDownloadDialog;
end;

procedure TUserLibrary.WebExplorerExtensions1Click(Sender: TObject);
begin
 ViewSelectPlugins(1);
end;

procedure TUserLibrary.WebExplorerServices1Click(Sender: TObject);
begin
 ViewSelectPlugins(2);
end;

function TUserLibrary.WebExplorerUpdate: Boolean;
var
...
procedure TUserLibrary.WindowsPlugins1Click(Sender: TObject);
begin
 ViewSelectPlugins(0);
end;

procedure TUserLibrary.ComplementsOptionsClick(Sender: TObject);
var
  button: TControl;
  lowerLeft: TPoint;
begin
...
function TUserLibrary.ConvertVerToInt(VerStr: string): int64;
var
 Value: integer;
begin
   VerStr := trim(VerStr);
...
procedure TUserLibrary.WninstallWidget1Click(Sender: TObject);
begin
 try
...
procedure TUserLibrary.CapbarSizeTimerTimer(Sender: TObject);
begin
...
procedure TUserLibrary.bt2Click(Sender: TObject);
var
...
procedure TUserLibrary.bt3Click(Sender: TObject);
var
...
procedure TUserLibrary.bt4Click(Sender: TObject);
var
...
procedure TUserLibrary.Button1Click(Sender: TObject);
begin
 MainForm.ShowSecPermHub(2);
end;

procedure TUserLibrary.Button2Click(Sender: TObject);
begin
 MainForm.ShowSecPermHub(1);
end;

procedure TUserLibrary.Button3Click(Sender: TObject);
begin
 MainForm.ShowSecPermHub(0);
end;

procedure TUserLibrary.Button4Click(Sender: TObject);
begin
 MainForm.OpenForm('WENetID', '', '', True, 0, true);
end;

procedure TUserLibrary.Button5Click(Sender: TObject);
begin
 MainForm.ClearCache := true;
 close;
end;

procedure TUserLibrary.Button6Click(Sender: TObject);
begin
 MainForm.ClearOnlyHis;
 close;
end;

procedure TUserLibrary.ButtonedEdit1RightButtonClick(Sender: TObject);
begin
  ShellExecute(handle,'open', Pchar(MainForm.Profile_Pach + '\History'), nil,nil,SW_SHOWNORMAL);
end;

procedure TUserLibrary.ButtonedEdit2RightButtonClick(Sender: TObject);
begin
 ShellExecute(handle,'open', Pchar(MainForm.Profile_Pach + '\Bookmarks'), nil,nil,SW_SHOWNORMAL);
end;

procedure TUserLibrary.ButtonedEdit3RightButtonClick(Sender: TObject);
begin
{$IFDEF STORE}
...
procedure TUserLibrary.ButtonedEdit4RightButtonClick(Sender: TObject);
begin
 ShellExecute(handle,'open', Pchar(MainForm.Profile_Pach), nil,nil,SW_SHOWNORMAL);
end;

procedure TUserLibrary.ButtonedEdit5RightButtonClick(Sender: TObject);
begin
 ShellExecute(handle,'open', Pchar(AppMenu.opt_downloaddir.Text), nil,nil,SW_SHOWNORMAL);
end;

procedure TUserLibrary.ButtonedEdit6KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if Key = VK_UP then
  begin
...
procedure TUserLibrary.ButtonedEdit6KeyPress(Sender: TObject; var Key: Char);
var
  tStr : String;
  tSrch : String;
  i : Integer;
...
procedure TUserLibrary.AddDownloadTolist(DownloadName, DownloadFolder, DownloadDesc: string);
var
...
procedure TUserLibrary.AddOnBt1Click(Sender: TObject);
begin
 close;
 if MainForm.AeroTabs.Tabs.Count = 0 then
  begin
...
procedure TUserLibrary.AddWidgets1Click(Sender: TObject);
begin
 close;
 //$@DCEF4
...
procedure TUserLibrary.AlignAll;
begin
...
procedure TUserLibrary.AppListDblClick(Sender: TObject);
begin
try
 ShellListView1.ItemIndex := AppList.ItemIndex;
 ShellExecute(handle,'open',Pchar(ShellListView1.SelectedFolder.PathName), '','',SW_SHOWNORMAL);
...
procedure TUserLibrary.AppListKeyPress(Sender: TObject; var Key: Char);
begin
 ShellListView1.ItemIndex := AppList.ItemIndex;
 if Key = #13 then
  begin
...
procedure TUserLibrary.bt1Click(Sender: TObject);
var
 MenuPosition1: TPoint;
begin
...
procedure TUserLibrary.ChangeItens(LibraryIndex: SmallInt);
begin
...
procedure TUserLibrary.CheckSPDFileUpdate;
var
 ...
 if (SPDFileDateCurrent <= SPDFileDateLimit) then
  begin
   try
    ...
    SPDFileUpdater.Strings[42] := SpeedDialTemplate.Lines[42];
   finally
...
procedure TUserLibrary.ClearDownloads;
begin
 try
  begin
...
procedure TUserLibrary.CreateShortcut(FileName, Parameters, InitialDir,
...
procedure TUserLibrary.CreateShortcut1Click(Sender: TObject);
begin
try
 try
  ShellListView1.ItemIndex := AppList.ItemIndex;
...
procedure TUserLibrary.DeleteItem1Click(Sender: TObject);
begin
 if SPDItensV.ItemIndex < 0 then
...
procedure TUserLibrary.DeleteLink1Click(Sender: TObject);
begin
...
procedure TUserLibrary.DeleteLinkClick(Sender: TObject);
var
 name_relink: string;
begin
 try
...
procedure TUserLibrary.DownloadPluginBTClick(Sender: TObject);
begin
...
procedure TUserLibrary.EditLink1Click(Sender: TObject);
begin
 //$@DCEF4
...
procedure TUserLibrary.ExchangeItems(lv: TListView; const i, j: Integer);
var
  tempLI: TListItem;
begin
...
procedure TUserLibrary.Export1Click(Sender: TObject);
begin
 ExportBook;
end;

procedure TUserLibrary.ExportBook;
var
 index: integer;
begin
try
...
procedure TUserLibrary.ExtensionRemoveBTClick(Sender: TObject);
begin
...
procedure TUserLibrary.ExtensionUpdateBTClick(Sender: TObject);
begin
 ShellExecute(handle,'open',PChar(ExtractFilePath(Application.ExeName) + '.\WebExplorerNotification.exe'), '-dftmsg', nil,SW_SHOWNORMAL);
...
function TUserLibrary.ExtractTextInsideGivenTagEx(const Tag,
  Text: string): string;
var
...
procedure TUserLibrary.FileSearch(const PathName, FileName: string;
  const InDir: boolean);
var Rec  : TSearchRec;
    Path : string;
begin
...
procedure TUserLibrary.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  CapbarSizeTimer.Enabled := false;
  ListViewSelect1.ItemIndex := -1;
end;

procedure TUserLibrary.FormCreate(Sender: TObject);
begin
 if ParamStr(1) = '-library' then
  begin
   try
...
procedure TUserLibrary.FormResize(Sender: TObject);
begin
 AlignAll;
end;

procedure TUserLibrary.FormShow(Sender: TObject);
begin
 GetBookmarks;
 GetLinks;
 GetProfileSize;
...
procedure TUserLibrary.GetBookmarks;
var
 ListItem : TListItem;
 index: Integer;
begin
...
function TUserLibrary.GetDirSize(dir: string; subdir: Boolean): Longint;
var
  rec: TSearchRec;
  found: Integer;
begin
...
function TUserLibrary.GetFolderAge(Folder: string): TDateTime;
var
...
procedure TUserLibrary.GetHistotyPagesList;
var
 ListItem : TListItem;
...
procedure TUserLibrary.GetIconFile;
var
 Icon: TIcon;
 IconHandle: HIcon;
begin
...
procedure TUserLibrary.GetLanguage;
begin
 ...
 ListViewSelect1.Items[3].Caption := MainForm.LanguageCache.Lines[416];
...
procedure TUserLibrary.GetLinks;
var
 ListItem : TListItem;
 index: Integer;
 fav_name: string;
...
procedure TUserLibrary.GetPluginUpdate(PluginName, ServerPluginUrl,
...
procedure TUserLibrary.GetProfileSize;
begin
...
function TUserLibrary.GMTToLocalTime(GMTTime: TDateTime): TDateTime;
var
...
procedure TUserLibrary.HTMLParserImportKeyFound(Sender: TObject; Key, Results,
  OriginalLine: string);
var
  pos1, pos2: integer;
  Link, Name: String;
...
procedure TUserLibrary.Import1Click(Sender: TObject);
begin
 ImportBook;
end;

procedure TUserLibrary.ImportandExport1Click(Sender: TObject);
begin
...
procedure TUserLibrary.ImportBook;
begin
 ListViewImport.Clear;
...
procedure TUserLibrary.Links1Click(Sender: TObject);
begin
 if ParamStr(1) = '-library' then
...
procedure TUserLibrary.ListAllPlugins;
var
 Reg : TRegistry;
 Index: integer;
...
if WebExplorerServices1.Checked = true then
 begin
  ...
  ListItem.ImageIndex := 2;
  ListItem:= ListViewPlugins.Items.Add;
  ListItem.Caption := '(MPEG4 H.264 MP4, MPEG1 Layer-3 MP3) Audio/Video Codecs';
  ListItem.SubItems.Text := VersionFrameWork;
  ListItem.SubItems.Add(MainForm.LanguageCache.Lines[349]);
  ListItem.ImageIndex := 2;
  ListItem:= ListViewPlugins.Items.Add;
...
procedure TUserLibrary.ListExtensionTimer1Timer(Sender: TObject);
begin
...
procedure TUserLibrary.ListViewDownloadsClick(Sender: TObject);
begin
 try
...
procedure TUserLibrary.ListViewDownloadsDblClick(Sender: TObject);
begin
 try
  if ListViewDownloads.ItemIndex >= 0 then
   begin
...
procedure TUserLibrary.ListViewPluginsAdvancedCustomDrawSubItem(
...
procedure TUserLibrary.ListViewPluginsClick(Sender: TObject);
begin
 try
...
procedure TUserLibrary.ListViewPluginsKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 try
  if ListViewPlugins.Selected.SubItems[1] = PluginSatusText then
...
procedure TUserLibrary.ListViewSelect1Change(Sender: TObject; Item: TListItem;
  Change: TItemChange);
begin
 try
...
procedure TUserLibrary.ListViewWndProc(var Msg: TMessage);
begin
...
procedure TUserLibrary.ListView_foldersClick(Sender: TObject);
begin
try
...
procedure TUserLibrary.ListView_foldersResize(Sender: TObject);
begin
...
function TUserLibrary.ListWEProcess(const Substring, Text: string): integer;
var
 offset: integer;
 MyHandle: THandle;
...
procedure TUserLibrary.ListWidgets;
var
 index: integer;
 ListItem : TListItem;
 btRect: TRect;
...
procedure TUserLibrary.ListWidgetTimerTimer(Sender: TObject);
begin
...
procedure TUserLibrary.Loaddownloadlist;
var
 index: Integer;
begin
DownloadIcons.Clear;
...
procedure TUserLibrary.LoadSPDItens;
var
 pngbmp: TPngImage;
 bmp: TBitmap;
 ListItem : TListItem;
...
procedure TUserLibrary.MoveDown1Click(Sender: TObject);
begin
 try
...
procedure TUserLibrary.MoveUp1Click(Sender: TObject);
begin
 try
  ExchangeItems(SPDItens,SPDItens.Selected.Index,SPDItens.Selected.Index-1);
 finally
...
procedure TUserLibrary.NewFolder1Click(Sender: TObject);
var
 dir_name: string;
begin
...
procedure TUserLibrary.NewLink1Click(Sender: TObject);
begin
  MainForm.AddtoBookmarks1.Click;
end;

procedure TUserLibrary.OpenDownloadDialog;
var
 OpenIcon: TIcon;
begin
 try
...
procedure TUserLibrary.OpendownloadDialogButtonClick(Sender: TObject;
  ButtonID: Integer);
begin
...
function TUserLibrary.OsSupportVersion: Boolean;
begin
...
procedure TUserLibrary.PluginOptBT2Click(Sender: TObject);
begin
 try
  begin
   if ListViewPlugins.Items[ListViewPlugins.ItemIndex].Caption = 'Adobe Flash Player (PPAPI)' then
...
procedure TUserLibrary.PluginOptBTClick(Sender: TObject);
begin
 try
  begin
   if ListViewPlugins.Items[ListViewPlugins.ItemIndex].Caption = 'Adobe Flash Player' then
...
procedure TUserLibrary.PopupMenu2Popup(Sender: TObject);
begin
...
procedure TUserLibrary.PopupMenu4Popup(Sender: TObject);
begin
{$IFDEF STORE}
...
procedure TUserLibrary.RegisterDownloadFile(DownloadN, DownloadF,
  DownloadD: String);
var
  index: Integer;
  listitem: TListItem;
...
procedure TUserLibrary.RegistryIconExtraction(FileExtensionStr: string);
var
 RegKey : TRegistry;
 IconPos : integer;
...
procedure TUserLibrary.remoteupdateextTimer(Sender: TObject);
begin
...
procedure TUserLibrary.RemoveExtension(index: SmallInt);
begin
 try
...
procedure TUserLibrary.RemoveFolder1Click(Sender: TObject);
begin
{try
 if ListView_folders.ItemIndex <> -1 then
  begin
...
procedure TUserLibrary.RenameFolder1Click(Sender: TObject);
var
 dir_name: string;
begin
 if ListView_folders.ItemIndex <> -1 then
...
procedure TUserLibrary.RenameLink1Click(Sender: TObject);
var
 link_name: string;
begin
 if ListView.ItemIndex <> -1 then
...
function TUserLibrary.ReturnImgAdr(imgAdr: string): string;
begin
 Result := imgAdr + '.jpg';
end;

function TUserLibrary.ReturnIMGIndex(imgindex: string): string;
begin
{$IFDEF RELEASE or DEBUG}
 Result := '../../../Bin/Resources/Pages/images/' + imgindex + '.png';
{$ENDIF}
{$IFDEF STORE}
 Result := '../Pages/images/' + imgindex + '.png';
{$ENDIF}
end;
